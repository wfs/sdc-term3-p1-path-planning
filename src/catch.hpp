//#ifndef EXTENDEDKF_CATCH_HPP
//#define EXTENDEDKF_CATCH_HPP
//
//#endif //EXTENDEDKF_CATCH_HPP
        ...
        public:
            Text(std::string const &_str, TextAttributes const &_attr = TextAttributes())
                ...
                while (it != strEnd) {
                    ...
                    std::string suffix;
                    std::size_t width = (std::min)(static_cast<size_t>( strEnd - it ),
    ...
    namespace TestCaseTracking {
        ...
        public:
            ...
            virtual ITracker *findChild(NameAndLocation const &nameAndLocation) CATCH_OVERRIDE {
                Children::const_iterator it = std::find_if(m_children.begin(), m_children.end(),
...
namespace Catch {
    ...
    private: // IResultCapture
        ...
        virtual void assertionEnded(AssertionResult const &result) {
            ...
            // Reset working state
            m_lastAssertionInfo = AssertionInfo(std::string(), m_lastAssertionInfo.lineInfo,
    ...
    private:
        ...
        void runCurrentTest(std::string &redirectedCout, std::string &redirectedCerr) {
            ...
            m_shouldReportUnexpected = true;
            try {
                m_lastAssertionInfo = AssertionInfo("TEST_CASE", testCaseInfo.lineInfo, std::string(),
